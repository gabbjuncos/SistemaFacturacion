...
public class DataManager
{
    ...
    public DataManager()
    {
		...
		var string_conexion = @"Data Source=sql5057.site4now.net;Initial Catalog=DB_A6807A_TPIPAVI;User ID=DB_A6807A_TPIPAVI_admin;Password=gabijunPAV1;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
